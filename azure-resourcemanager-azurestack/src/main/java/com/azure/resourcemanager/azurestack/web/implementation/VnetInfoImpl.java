...
public final class VnetInfoImpl implements VnetInfo, VnetInfo.Definition, VnetInfo.Update {
    ...
    VnetInfoImpl(String name, com.azure.resourcemanager.azurestack.web.AppServiceManager serviceManager) {
    ...
    VnetInfoImpl(VnetInfoInner innerObject, com.azure.resourcemanager.azurestack.web.AppServiceManager serviceManager) {
