...
import com.azure.resourcemanager.azurestack.appservice.fluent.AppServicePlansClient;
import com.azure.resourcemanager.azurestack.appservice.fluent.models.AppServicePlanInner;
...
import com.azure.resourcemanager.azurestack.appservice.fluent.models.HybridConnectionLimitsInner;
...
import com.azure.resourcemanager.azurestack.appservice.fluent.models.VnetRouteInner;
import com.azure.resourcemanager.azurestack.appservice.models.AppServicePlan;
import com.azure.resourcemanager.azurestack.appservice.models.AppServicePlans;
...
import com.azure.resourcemanager.azurestack.appservice.models.HybridConnectionLimits;
...
import com.azure.resourcemanager.azurestack.appservice.models.VnetRoute;
...
public final class AppServicePlansImpl implements AppServicePlans {
    ...
    public AppServicePlansImpl(
        AppServicePlansClient innerClient, com.azure.resourcemanager.azurestack.appservice.AppServiceManager serviceManager) {
    ...
    public PagedIterable<ResourceMetricDefinition> listMetricDefintions(String resourceGroupName, String name) {
        PagedIterable<ResourceMetricDefinitionInner> inner =
            this.serviceClient().listMetricDefintions(resourceGroupName, name);
        return Utils.mapPage(inner, inner1 -> new ResourceMetricDefinitionImpl(inner1, this.manager()));
    }

    public PagedIterable<ResourceMetricDefinition> listMetricDefintions(
        String resourceGroupName, String name, Context context) {
        PagedIterable<ResourceMetricDefinitionInner> inner =
            this.serviceClient().listMetricDefintions(resourceGroupName, name, context);
        return Utils.mapPage(inner, inner1 -> new ResourceMetricDefinitionImpl(inner1, this.manager()));
    }
