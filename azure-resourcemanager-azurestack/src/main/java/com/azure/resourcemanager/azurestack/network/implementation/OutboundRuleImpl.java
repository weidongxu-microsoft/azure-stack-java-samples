...
import com.azure.resourcemanager.azurestack.network.models.OutboundRulePropertiesFormatProtocol;
...
public final class OutboundRuleImpl implements OutboundRule {
    ...
    OutboundRuleImpl(
        OutboundRuleInner innerObject, com.azure.resourcemanager.azurestack.network.NetworkManager serviceManager) {
