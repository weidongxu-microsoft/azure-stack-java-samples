...
public final class ProcessThreadInfoImpl implements ProcessThreadInfo {
    ...
    ProcessThreadInfoImpl(
        ProcessThreadInfoInner innerObject, com.azure.resourcemanager.azurestack.appservice.AppServiceManager serviceManager) {
    ...
    public String priviledgedProcessorTime() {
        return this.innerModel().priviledgedProcessorTime();
    }
