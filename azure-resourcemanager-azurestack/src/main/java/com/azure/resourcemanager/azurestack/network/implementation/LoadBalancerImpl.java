...
import com.azure.resourcemanager.azurestack.network.fluent.models.LoadBalancerInner;
...
import com.azure.resourcemanager.azurestack.network.fluent.models.ProbeInner;
import com.azure.resourcemanager.azurestack.network.models.BackendAddressPool;
import com.azure.resourcemanager.azurestack.network.models.FrontendIpConfiguration;
import com.azure.resourcemanager.azurestack.network.models.InboundNatPool;
import com.azure.resourcemanager.azurestack.network.models.InboundNatRule;
import com.azure.resourcemanager.azurestack.network.models.LoadBalancer;
import com.azure.resourcemanager.azurestack.network.models.LoadBalancerSku;
import com.azure.resourcemanager.azurestack.network.models.LoadBalancingRule;
import com.azure.resourcemanager.azurestack.network.models.OutboundRule;
import com.azure.resourcemanager.azurestack.network.models.Probe;
...
public final class LoadBalancerImpl implements LoadBalancer, LoadBalancer.Definition, LoadBalancer.Update {
    ...
    LoadBalancerImpl(String name, com.azure.resourcemanager.azurestack.network.NetworkManager serviceManager) {
    ...
    public LoadBalancer apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getLoadBalancers()
                .updateTags(resourceGroupName, loadBalancerName, updateParameters, Context.NONE);
        return this;
    }
    ...
    public LoadBalancer apply(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getLoadBalancers()
                .updateTags(resourceGroupName, loadBalancerName, updateParameters, context);
        return this;
    }

    LoadBalancerImpl(
        LoadBalancerInner innerObject, com.azure.resourcemanager.azurestack.network.NetworkManager serviceManager) {
