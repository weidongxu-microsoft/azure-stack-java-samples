...
public interface VirtualNetworkPeering {
    ...
    /**
     * Gets the allowVirtualNetworkAccess property: Whether the VMs in the linked virtual network space would be able to
    ...
    /**
     * Gets the allowForwardedTraffic property: Whether the forwarded traffic from the VMs in the remote virtual network
    ...
    /**
     * Gets the remoteVirtualNetwork property: The reference of the remote virtual network. The remote virtual network
    ...
    /**
     * Gets the remoteAddressSpace property: The reference of the remote virtual network address space.
     *
    ...
    /**
     * Gets the peeringState property: The status of the virtual network peering. Possible values are 'Initiated',
    ...
    /**
     * Gets the inner com.azure.resourcemanager.azurestack.network.fluent.models.VirtualNetworkPeeringInner object.
     *
