...
import com.azure.resourcemanager.azurestack.resources.models.ProviderListResult;
...
public final class ProvidersClientImpl implements ProvidersClient {
    ...
    private Mono<PagedResponse<ProviderInner>> listSinglePageAsync(Integer top, String expand, Context context) {
        ...
        context = this.client.mergeContext(context);
        return service
            .list(this.client.getEndpoint(), top, expand, apiVersion, this.client.getSubscriptionId(), accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
    ...
    private Mono<PagedResponse<ProviderInner>> listAtTenantScopeSinglePageAsync(Integer top, String expand) {
        ...
        return FluxUtil
            .withContext(
                context ->
                    service.listAtTenantScope(this.client.getEndpoint(), top, expand, apiVersion, accept, context))
            .<PagedResponse<ProviderInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
    ...
    private Mono<PagedResponse<ProviderInner>> listAtTenantScopeSinglePageAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .listAtTenantScope(this.client.getEndpoint(), top, expand, apiVersion, accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
        ...
        return FluxUtil
            .withContext(
                context ->
                    service
                        .getAtTenantScope(
                            this.client.getEndpoint(), expand, resourceProviderNamespace, apiVersion, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
