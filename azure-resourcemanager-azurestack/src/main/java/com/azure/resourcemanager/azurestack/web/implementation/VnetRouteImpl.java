...
import com.azure.resourcemanager.azurestack.web.models.RouteType;
...
public final class VnetRouteImpl implements VnetRoute, VnetRoute.Definition, VnetRoute.Update {
    ...
    VnetRouteImpl(String name, com.azure.resourcemanager.azurestack.web.AppServiceManager serviceManager) {
    ...
    VnetRouteImpl(
        VnetRouteInner innerObject, com.azure.resourcemanager.azurestack.web.AppServiceManager serviceManager) {
