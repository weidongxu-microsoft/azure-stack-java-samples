...
public final class ConsumerGroupImpl implements ConsumerGroup, ConsumerGroup.Definition, ConsumerGroup.Update {
    ...
    ConsumerGroupImpl(String name, com.azure.resourcemanager.azurestack.eventhubs.EventHubsManager serviceManager) {
    ...
    ConsumerGroupImpl(
        ConsumerGroupInner innerObject, com.azure.resourcemanager.azurestack.eventhubs.EventHubsManager serviceManager) {
