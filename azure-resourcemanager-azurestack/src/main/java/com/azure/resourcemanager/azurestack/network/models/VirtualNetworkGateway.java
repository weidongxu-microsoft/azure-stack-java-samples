...
import com.azure.resourcemanager.azurestack.network.fluent.models.VirtualNetworkGatewayInner;
...
public interface VirtualNetworkGateway {
    ...
    /**
     * Gets the gatewayType property: The type of this virtual network gateway. Possible values are: 'Vpn' and
     * 'ExpressRoute'.
     *
    ...
    /**
     * Gets the vpnType property: The type of this virtual network gateway. Possible values are: 'PolicyBased' and
     * 'RouteBased'.
     *
    ...
    /**
     * Gets the gatewayDefaultSite property: The reference of the LocalNetworkGateway resource which represents local
    ...
    /**
     * Gets the sku property: The reference of the VirtualNetworkGatewaySku resource which represents the SKU selected
    ...
    /**
     * Gets the vpnClientConfiguration property: The reference of the VpnClientConfiguration resource which represents
    ...
    /**
     * Gets the resourceGuid property: The resource GUID property of the VirtualNetworkGateway resource.
     *
    ...
    /**
     * Gets the provisioningState property: The provisioning state of the VirtualNetworkGateway resource. Possible
    ...
    /**
     * Gets the inner com.azure.resourcemanager.azurestack.network.fluent.models.VirtualNetworkGatewayInner object.
     *
    ...
    interface DefinitionStages {
        ...
        interface WithGatewayType {
            /**
             * Specifies the gatewayType property: The type of this virtual network gateway. Possible values are: 'Vpn'
             * and 'ExpressRoute'..
             *
             * @param gatewayType The type of this virtual network gateway. Possible values are: 'Vpn' and
             *     'ExpressRoute'.
             * @return the next definition stage.
             */
        ...
        interface WithVpnType {
            /**
             * Specifies the vpnType property: The type of this virtual network gateway. Possible values are:
             * 'PolicyBased' and 'RouteBased'..
             *
             * @param vpnType The type of this virtual network gateway. Possible values are: 'PolicyBased' and
             *     'RouteBased'.
             * @return the next definition stage.
             */
        ...
        interface WithGatewayDefaultSite {
            /**
             * Specifies the gatewayDefaultSite property: The reference of the LocalNetworkGateway resource which
             * represents local network site having default routes. Assign Null value in case of removing existing
             * default site setting..
             *
             * @param gatewayDefaultSite The reference of the LocalNetworkGateway resource which represents local
        ...
        interface WithSku {
            /**
             * Specifies the sku property: The reference of the VirtualNetworkGatewaySku resource which represents the
             * SKU selected for Virtual network gateway..
             *
             * @param sku The reference of the VirtualNetworkGatewaySku resource which represents the SKU selected for
        ...
        interface WithVpnClientConfiguration {
            /**
             * Specifies the vpnClientConfiguration property: The reference of the VpnClientConfiguration resource which
             * represents the P2S VpnClient configurations..
             *
             * @param vpnClientConfiguration The reference of the VpnClientConfiguration resource which represents the
        ...
        interface WithResourceGuid {
            /**
             * Specifies the resourceGuid property: The resource GUID property of the VirtualNetworkGateway resource..
             *
