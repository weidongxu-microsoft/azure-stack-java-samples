...
import com.azure.resourcemanager.azurestack.appservice.fluent.ProvidersClient;
...
import com.azure.resourcemanager.azurestack.appservice.models.ApplicationStackCollection;
import com.azure.resourcemanager.azurestack.appservice.models.CsmOperationCollection;
import com.azure.resourcemanager.azurestack.appservice.models.DefaultErrorResponseErrorException;
import com.azure.resourcemanager.azurestack.appservice.models.ProviderOsTypeSelected;
...
public final class ProvidersClientImpl implements ProvidersClient {
    ...
    private PagedFlux<ApplicationStackInner> getAvailableStacksAsync(ProviderOsTypeSelected osTypeSelected) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ApplicationStackInner> listAsync(ProviderOsTypeSelected osTypeSelected) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ApplicationStackInner> listAsync() {
        final ProviderOsTypeSelected osTypeSelected = null;
        return new PagedFlux<>(
            () -> listSinglePageAsync(osTypeSelected),
            nextLink -> getAvailableStacksOnPremNextSinglePageAsync(nextLink));
