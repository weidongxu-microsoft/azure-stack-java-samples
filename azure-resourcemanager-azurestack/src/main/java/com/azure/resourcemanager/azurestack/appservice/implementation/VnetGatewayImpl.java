...
public final class VnetGatewayImpl implements VnetGateway, VnetGateway.Definition, VnetGateway.Update {
    ...
    VnetGatewayImpl(String name, com.azure.resourcemanager.azurestack.appservice.AppServiceManager serviceManager) {
    ...
    VnetGatewayImpl(
        VnetGatewayInner innerObject, com.azure.resourcemanager.azurestack.appservice.AppServiceManager serviceManager) {
