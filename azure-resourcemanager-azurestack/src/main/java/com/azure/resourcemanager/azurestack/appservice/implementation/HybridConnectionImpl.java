...
public final class HybridConnectionImpl
    ...
    HybridConnectionImpl(String name, com.azure.resourcemanager.azurestack.appservice.AppServiceManager serviceManager) {
    ...
    HybridConnectionImpl(
        HybridConnectionInner innerObject, com.azure.resourcemanager.azurestack.appservice.AppServiceManager serviceManager) {
    ...
    public HybridConnectionKey listHybridConnectionKeys() {
        return serviceManager.webApps().listHybridConnectionKeys(resourceGroupName, name, namespaceName, relayName);
    }

    public Response<HybridConnectionKey> listHybridConnectionKeysWithResponse(Context context) {
