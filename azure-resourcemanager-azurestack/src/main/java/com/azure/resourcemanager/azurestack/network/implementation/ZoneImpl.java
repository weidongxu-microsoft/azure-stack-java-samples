...
import com.azure.resourcemanager.azurestack.network.models.ZoneType;
...
public final class ZoneImpl implements Zone, Zone.Definition, Zone.Update {
    ...
    ZoneImpl(String name, com.azure.resourcemanager.azurestack.network.NetworkManager serviceManager) {
    ...
    ZoneImpl(ZoneInner innerObject, com.azure.resourcemanager.azurestack.network.NetworkManager serviceManager) {
