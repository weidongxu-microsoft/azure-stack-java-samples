...
import com.azure.resourcemanager.azurestack.resources.fluent.TagOperationsClient;
import com.azure.resourcemanager.azurestack.resources.fluent.models.TagDetailsInner;
...
import com.azure.resourcemanager.azurestack.resources.models.TagsListResult;
import com.azure.resourcemanager.azurestack.resources.models.TagsPatchResource;
...
public final class TagOperationsClientImpl implements TagOperationsClient {
    ...
    private Mono<Response<TagDetailsInner>> createOrUpdateWithResponseAsync(String tagName, Context context) {
        ...
        return service
            .createOrUpdate(
                this.client.getEndpoint(), tagName, apiVersion, this.client.getSubscriptionId(), accept, context);
    }
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(String tagName, Context context) {
        ...
        context = this.client.mergeContext(context);
        return service
            .delete(this.client.getEndpoint(), tagName, apiVersion, this.client.getSubscriptionId(), accept, context);
    }
                ...
                context ->
                    service
                        .createOrUpdateAtScope(
                            this.client.getEndpoint(), scope, apiVersion, parameters, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<TagsResourceInner>> createOrUpdateAtScopeWithResponseAsync(
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.createOrUpdateAtScope(this.client.getEndpoint(), scope, apiVersion, parameters, accept, context);
    }
    ...
    private Mono<Response<TagsResourceInner>> updateAtScopeWithResponseAsync(
        ...
        return FluxUtil
            .withContext(
                context ->
                    service.updateAtScope(this.client.getEndpoint(), scope, apiVersion, parameters, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<TagsResourceInner>> updateAtScopeWithResponseAsync(
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.updateAtScope(this.client.getEndpoint(), scope, apiVersion, parameters, accept, context);
    }
    ...
    private Mono<Response<TagsResourceInner>> getAtScopeWithResponseAsync(String scope) {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.getAtScope(this.client.getEndpoint(), scope, apiVersion, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<TagsResourceInner>> getAtScopeWithResponseAsync(String scope, Context context) {
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getAtScope(this.client.getEndpoint(), scope, apiVersion, accept, context);
    }
    ...
    private Mono<Response<Void>> deleteAtScopeWithResponseAsync(String scope) {
        ...
        return FluxUtil
            .withContext(
                context -> service.deleteAtScope(this.client.getEndpoint(), scope, apiVersion, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Void>> deleteAtScopeWithResponseAsync(String scope, Context context) {
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.deleteAtScope(this.client.getEndpoint(), scope, apiVersion, accept, context);
    }
