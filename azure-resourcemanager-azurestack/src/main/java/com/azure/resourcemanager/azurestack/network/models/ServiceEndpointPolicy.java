...
public class ServiceEndpointPolicy extends Resource {
     ...
     */
    public ServiceEndpointPolicy withEtag(String etag) {
        this.etag = etag;
        return this;
    }
     ...
     * @return the ServiceEndpointPolicy object itself.
     */
    public ServiceEndpointPolicy withServiceEndpointPolicyDefinitions(
     ...
     * @return the ServiceEndpointPolicy object itself.
     */
    public ServiceEndpointPolicy withId(String id) {
        this.id = id;
        return this;
    }
    ...
    /** {@inheritDoc} */
    @Override
    public ServiceEndpointPolicy withLocation(String location) {
    ...
    /** {@inheritDoc} */
    @Override
    public ServiceEndpointPolicy withTags(Map<String, String> tags) {
        super.withTags(tags);
        return this;
    }
