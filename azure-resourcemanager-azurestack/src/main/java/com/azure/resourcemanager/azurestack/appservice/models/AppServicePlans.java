...
public interface AppServicePlans {
     ...
     */
    PagedIterable<ResourceMetricDefinition> listMetricDefintions(String resourceGroupName, String name);
     ...
     * @return metrics that can be queried for an App Service plan, and their definitions.
     */
    PagedIterable<ResourceMetricDefinition> listMetricDefintions(
        String resourceGroupName, String name, Context context);
