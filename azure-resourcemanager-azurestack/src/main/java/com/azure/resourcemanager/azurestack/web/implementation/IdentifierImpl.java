...
public final class IdentifierImpl implements Identifier, Identifier.Definition, Identifier.Update {
    ...
    IdentifierImpl(String name, com.azure.resourcemanager.azurestack.web.AppServiceManager serviceManager) {
    ...
    IdentifierImpl(
        IdentifierInner innerObject, com.azure.resourcemanager.azurestack.web.AppServiceManager serviceManager) {
