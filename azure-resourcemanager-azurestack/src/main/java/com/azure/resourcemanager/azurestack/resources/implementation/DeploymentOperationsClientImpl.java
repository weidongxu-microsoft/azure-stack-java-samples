...
import com.azure.resourcemanager.azurestack.resources.fluent.DeploymentOperationsClient;
import com.azure.resourcemanager.azurestack.resources.fluent.models.DeploymentOperationInner;
import com.azure.resourcemanager.azurestack.resources.models.DeploymentOperationsListResult;
...
public final class DeploymentOperationsClientImpl implements DeploymentOperationsClient {
        ...
        return FluxUtil
            .withContext(
                context ->
                    service
                        .getAtScope(
                            this.client.getEndpoint(), scope, deploymentName, operationId, apiVersion, accept, context))
    ...
    private Mono<Response<DeploymentOperationInner>> getAtScopeWithResponseAsync(
        ...
        return service
            .getAtScope(this.client.getEndpoint(), scope, deploymentName, operationId, apiVersion, accept, context);
    }
        ...
        return FluxUtil
            .withContext(
                context ->
                    service
                        .listAtScope(
                            this.client.getEndpoint(), scope, deploymentName, top, apiVersion, accept, context))
    ...
    private Mono<PagedResponse<DeploymentOperationInner>> listAtScopeSinglePageAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .listAtScope(this.client.getEndpoint(), scope, deploymentName, top, apiVersion, accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
        ...
        return FluxUtil
            .withContext(
                context ->
                    service
                        .getAtTenantScope(
                            this.client.getEndpoint(), deploymentName, operationId, apiVersion, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<DeploymentOperationInner>> getAtTenantScopeWithResponseAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .getAtTenantScope(this.client.getEndpoint(), deploymentName, operationId, apiVersion, accept, context);
    }
    ...
    private Mono<PagedResponse<DeploymentOperationInner>> listAtTenantScopeSinglePageAsync(
        ...
        return FluxUtil
            .withContext(
                context ->
                    service
                        .listAtTenantScope(this.client.getEndpoint(), deploymentName, top, apiVersion, accept, context))
            .<PagedResponse<DeploymentOperationInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
    ...
    private Mono<Response<DeploymentOperationInner>> getAtManagementGroupScopeWithResponseAsync(
        ...
        return service
            .getAtManagementGroupScope(
                this.client.getEndpoint(), groupId, deploymentName, operationId, apiVersion, accept, context);
    }
                ...
                context ->
                    service
                        .listAtManagementGroupScope(
                            this.client.getEndpoint(), groupId, deploymentName, top, apiVersion, accept, context))
            .<PagedResponse<DeploymentOperationInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
