...
public final class HostnameBindingImpl implements HostnameBinding, HostnameBinding.Definition, HostnameBinding.Update {
    ...
    HostnameBindingImpl(String name, com.azure.resourcemanager.azurestack.web.AppServiceManager serviceManager) {
    ...
    HostnameBindingImpl(
        HostnameBindingInner innerObject, com.azure.resourcemanager.azurestack.web.AppServiceManager serviceManager) {
