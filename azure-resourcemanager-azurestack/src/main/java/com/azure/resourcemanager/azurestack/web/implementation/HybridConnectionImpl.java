...
public final class HybridConnectionImpl
    ...
    HybridConnectionImpl(String name, com.azure.resourcemanager.azurestack.web.AppServiceManager serviceManager) {
    ...
    HybridConnectionImpl(
        HybridConnectionInner innerObject, com.azure.resourcemanager.azurestack.web.AppServiceManager serviceManager) {
