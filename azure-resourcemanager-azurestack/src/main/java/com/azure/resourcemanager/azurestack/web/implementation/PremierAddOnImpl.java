...
public final class PremierAddOnImpl implements PremierAddOn, PremierAddOn.Definition, PremierAddOn.Update {
    ...
    PremierAddOnImpl(String name, com.azure.resourcemanager.azurestack.web.AppServiceManager serviceManager) {
    ...
    PremierAddOnImpl(
        PremierAddOnInner innerObject, com.azure.resourcemanager.azurestack.web.AppServiceManager serviceManager) {
