...
public final class DeploymentImpl implements Deployment, Deployment.Definition {
    ...
    DeploymentImpl(
        DeploymentInner innerObject, com.azure.resourcemanager.azurestack.web.AppServiceManager serviceManager) {
    ...
    DeploymentImpl(String name, com.azure.resourcemanager.azurestack.web.AppServiceManager serviceManager) {
