...
public final class FunctionEnvelopeImpl implements FunctionEnvelope, FunctionEnvelope.Definition {
    ...
    FunctionEnvelopeImpl(
        FunctionEnvelopeInner innerObject, com.azure.resourcemanager.azurestack.appservice.AppServiceManager serviceManager) {
    ...
    FunctionEnvelopeImpl(String name, com.azure.resourcemanager.azurestack.appservice.AppServiceManager serviceManager) {
