...
public final class SiteImpl implements Site, Site.Definition, Site.Update {
    ...
    SiteImpl(String name, com.azure.resourcemanager.azurestack.appservice.AppServiceManager serviceManager) {
    ...
    SiteImpl(SiteInner innerObject, com.azure.resourcemanager.azurestack.appservice.AppServiceManager serviceManager) {
