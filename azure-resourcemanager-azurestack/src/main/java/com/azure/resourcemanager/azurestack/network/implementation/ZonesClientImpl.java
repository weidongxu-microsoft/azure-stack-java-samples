...
import com.azure.resourcemanager.azurestack.network.models.ZoneListResult;
...
public final class ZonesClientImpl implements ZonesClient {
     ...
     */
    ZonesClientImpl(NetworkManagementClientImpl client) {
        this.service = RestProxy.create(ZonesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for NetworkManagementClientZones to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    ...
    private Mono<Response<ZoneInner>> createOrUpdateWithResponseAsync(
        ...
        final String apiVersion = "2016-04-01";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ZoneDeleteResultInner> deleteAsync(String resourceGroupName, String zoneName, String ifMatch) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ZoneDeleteResultInner> deleteAsync(String resourceGroupName, String zoneName) {
        final String ifMatch = null;
        return beginDeleteAsync(resourceGroupName, zoneName, ifMatch)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
