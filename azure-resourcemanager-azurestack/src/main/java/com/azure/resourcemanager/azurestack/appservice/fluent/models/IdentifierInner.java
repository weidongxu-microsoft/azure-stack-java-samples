...
public class IdentifierInner extends ProxyOnlyResource {
    ...
    /**
     * Get the idPropertiesId property: String representation of the identity.
     *
    ...
    /**
     * Set the idPropertiesId property: String representation of the identity.
     *
     * @param idPropertiesId the idPropertiesId value to set.
     * @return the IdentifierInner object itself.
     */
    public IdentifierInner withIdPropertiesId(String idPropertiesId) {
