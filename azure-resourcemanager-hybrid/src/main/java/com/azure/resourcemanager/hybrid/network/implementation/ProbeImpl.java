...
import com.azure.resourcemanager.hybrid.network.models.ProbeProtocol;
...
public final class ProbeImpl implements Probe {
    ...
    ProbeImpl(ProbeInner innerObject, com.azure.resourcemanager.hybrid.network.NetworkManager serviceManager) {
