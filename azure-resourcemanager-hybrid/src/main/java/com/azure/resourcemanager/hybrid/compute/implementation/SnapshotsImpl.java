...
import com.azure.resourcemanager.hybrid.compute.models.GrantAccessData;
...
public final class SnapshotsImpl implements Snapshots {
    ...
    public SnapshotsImpl(
        SnapshotsClient innerClient, com.azure.resourcemanager.hybrid.compute.ComputeManager serviceManager) {
