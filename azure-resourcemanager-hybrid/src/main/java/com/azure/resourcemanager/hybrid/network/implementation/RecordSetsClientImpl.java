...
import com.azure.resourcemanager.hybrid.network.models.RecordSetListResult;
import com.azure.resourcemanager.hybrid.network.models.RecordType;
...
public final class RecordSetsClientImpl implements RecordSetsClient {
     ...
     */
    RecordSetsClientImpl(NetworkManagementClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for NetworkManagementClientRecordSets to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
