...
public interface PolicyAssignments {
     ...
     * @return policy assignments for the resource group.
     */
    PagedIterable<PolicyAssignment> listByResourceGroup(String resourceGroupName, String filter, Context context);
     ...
     * @return all the policy assignments for a subscription.
     */
    PagedIterable<PolicyAssignment> list(String filter, Context context);
