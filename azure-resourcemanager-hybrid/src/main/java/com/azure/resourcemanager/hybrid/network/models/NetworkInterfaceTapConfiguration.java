...
public interface NetworkInterfaceTapConfiguration {
    ...
    /**
     * Gets the virtualNetworkTap property: The reference of the Virtual Network Tap resource.
     *
    ...
    /**
     * Gets the provisioningState property: The provisioning state of the network interface tap configuration. Possible
    ...
    /**
     * Gets the inner com.azure.resourcemanager.azurestack.network.fluent.models.NetworkInterfaceTapConfigurationInner
     * object.
     *
    ...
    interface DefinitionStages {
        ...
        interface WithCreate
            extends DefinitionStages.WithName, DefinitionStages.WithEtag, DefinitionStages.WithVirtualNetworkTap {
            /**
        ...
        interface WithVirtualNetworkTap {
            /**
             * Specifies the virtualNetworkTap property: The reference of the Virtual Network Tap resource..
             *
    ...
    interface Update extends UpdateStages.WithName, UpdateStages.WithEtag, UpdateStages.WithVirtualNetworkTap {
        /**
