...
public class ServiceEndpointPolicyDefinition extends SubResource {
     ...
     */
    public ServiceEndpointPolicyDefinition withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the ServiceEndpointPolicyDefinition object itself.
     */
    public ServiceEndpointPolicyDefinition withEtag(String etag) {
        this.etag = etag;
        return this;
    }
     ...
     * @return the ServiceEndpointPolicyDefinition object itself.
     */
    public ServiceEndpointPolicyDefinition withDescription(String description) {
     ...
     * @return the ServiceEndpointPolicyDefinition object itself.
     */
    public ServiceEndpointPolicyDefinition withService(String service) {
     ...
     * @return the ServiceEndpointPolicyDefinition object itself.
     */
    public ServiceEndpointPolicyDefinition withServiceResources(List<String> serviceResources) {
    ...
    /** {@inheritDoc} */
    @Override
    public ServiceEndpointPolicyDefinition withId(String id) {
        super.withId(id);
        return this;
    }
