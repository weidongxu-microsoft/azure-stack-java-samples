...
import com.azure.resourcemanager.hybrid.authorization.models.PolicyAssignmentListResult;
...
public final class PolicyAssignmentsClientImpl implements PolicyAssignmentsClient {
     ...
     */
    PolicyAssignmentsClientImpl(AuthorizationManagementClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for AuthorizationManagementClientPolicyAssignments to be used by the
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<PolicyAssignmentInner> listAsync(String filter) {
