...
public final class HybridConnectionImpl
    ...
    HybridConnectionImpl(String name, com.azure.resourcemanager.hybrid.appservice.AppServiceManager serviceManager) {
    ...
    HybridConnectionImpl(
        HybridConnectionInner innerObject, com.azure.resourcemanager.hybrid.appservice.AppServiceManager serviceManager) {
