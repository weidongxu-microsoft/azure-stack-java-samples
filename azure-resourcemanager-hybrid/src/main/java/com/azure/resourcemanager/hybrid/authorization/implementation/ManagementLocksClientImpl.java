...
import com.azure.resourcemanager.hybrid.authorization.models.ManagementLockListResult;
...
public final class ManagementLocksClientImpl implements ManagementLocksClient {
     ...
     */
    ManagementLocksClientImpl(AuthorizationManagementClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for AuthorizationManagementClientManagementLocks to be used by the proxy
                ...
                context ->
                    service
                        .createOrUpdateByScope(
                            this.client.getEndpoint(), scope, lockName, apiVersion, parameters, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<ManagementLockObjectInner>> createOrUpdateByScopeWithResponseAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .createOrUpdateByScope(this.client.getEndpoint(), scope, lockName, apiVersion, parameters, accept, context);
    }
    ...
    private Mono<Response<Void>> deleteByScopeWithResponseAsync(String scope, String lockName) {
        ...
        return FluxUtil
            .withContext(
                context -> service.deleteByScope(this.client.getEndpoint(), scope, lockName, apiVersion, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Void>> deleteByScopeWithResponseAsync(String scope, String lockName, Context context) {
        ...
        final String apiVersion = "2016-09-01";
        context = this.client.mergeContext(context);
        return service.deleteByScope(this.client.getEndpoint(), scope, lockName, apiVersion, context);
    }
    ...
    private Mono<Response<ManagementLockObjectInner>> getByScopeWithResponseAsync(String scope, String lockName) {
        ...
        return FluxUtil
            .withContext(
                context -> service.getByScope(this.client.getEndpoint(), scope, lockName, apiVersion, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<ManagementLockObjectInner>> getByScopeWithResponseAsync(
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getByScope(this.client.getEndpoint(), scope, lockName, apiVersion, accept, context);
    }
                ...
                context ->
                    service
                        .deleteAtSubscriptionLevel(
                            this.client.getEndpoint(), lockName, apiVersion, this.client.getSubscriptionId(), context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<ManagementLockObjectInner>> getAtSubscriptionLevelWithResponseAsync(
        ...
        return service
            .getAtSubscriptionLevel(
                this.client.getEndpoint(), lockName, apiVersion, this.client.getSubscriptionId(), accept, context);
    }
    ...
    private Mono<PagedResponse<ManagementLockObjectInner>> listByScopeSinglePageAsync(String scope, String filter) {
        ...
        return FluxUtil
            .withContext(
                context -> service.listByScope(this.client.getEndpoint(), scope, filter, apiVersion, accept, context))
            .<PagedResponse<ManagementLockObjectInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
    ...
    private Mono<PagedResponse<ManagementLockObjectInner>> listByScopeSinglePageAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .listByScope(this.client.getEndpoint(), scope, filter, apiVersion, accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
