...
import com.azure.resourcemanager.hybrid.compute.models.AvailabilitySetUpdate;
...
public final class AvailabilitySetImpl implements AvailabilitySet, AvailabilitySet.Definition, AvailabilitySet.Update {
    ...
    AvailabilitySetImpl(String name, com.azure.resourcemanager.hybrid.compute.ComputeManager serviceManager) {
    ...
    AvailabilitySetImpl(
        AvailabilitySetInner innerObject, com.azure.resourcemanager.hybrid.compute.ComputeManager serviceManager) {
