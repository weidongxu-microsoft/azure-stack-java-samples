...
import com.azure.resourcemanager.hybrid.network.fluent.models.VirtualNetworkInner;
...
import com.azure.resourcemanager.hybrid.network.models.DhcpOptions;
...
public final class VirtualNetworkImpl implements VirtualNetwork, VirtualNetwork.Definition, VirtualNetwork.Update {
    ...
    VirtualNetworkImpl(String name, com.azure.resourcemanager.hybrid.network.NetworkManager serviceManager) {
    ...
    VirtualNetworkImpl(
        VirtualNetworkInner innerObject, com.azure.resourcemanager.hybrid.network.NetworkManager serviceManager) {
