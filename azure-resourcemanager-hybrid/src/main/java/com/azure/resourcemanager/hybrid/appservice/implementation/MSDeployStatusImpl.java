...
import com.azure.resourcemanager.hybrid.appservice.models.MSDeployProvisioningState;
...
public final class MSDeployStatusImpl implements MSDeployStatus {
    ...
    MSDeployStatusImpl(
        MSDeployStatusInner innerObject, com.azure.resourcemanager.hybrid.appservice.AppServiceManager serviceManager) {
