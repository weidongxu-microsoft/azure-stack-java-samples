...
public final class LocalNetworkGatewayImpl
    ...
    LocalNetworkGatewayImpl(String name, com.azure.resourcemanager.hybrid.network.NetworkManager serviceManager) {
    ...
    public LocalNetworkGateway apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getLocalNetworkGateways()
                .updateTags(resourceGroupName, localNetworkGatewayName, updateParameters, Context.NONE);
        return this;
    }
    ...
    public LocalNetworkGateway apply(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getLocalNetworkGateways()
                .updateTags(resourceGroupName, localNetworkGatewayName, updateParameters, context);
        return this;
    }
