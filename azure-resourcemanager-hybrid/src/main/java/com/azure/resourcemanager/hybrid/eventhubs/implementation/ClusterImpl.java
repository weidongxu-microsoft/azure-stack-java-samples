...
import com.azure.resourcemanager.hybrid.eventhubs.models.ClusterSku;
...
public final class ClusterImpl implements Cluster, Cluster.Definition, Cluster.Update {
    ...
    ClusterImpl(String name, com.azure.resourcemanager.hybrid.eventhubs.EventHubsManager serviceManager) {
    ...
    ClusterImpl(
        ClusterInner innerObject, com.azure.resourcemanager.hybrid.eventhubs.EventHubsManager serviceManager) {
