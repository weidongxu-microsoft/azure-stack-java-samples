...
import com.azure.resourcemanager.hybrid.resources.models.TenantListResult;
...
public final class TenantsClientImpl implements TenantsClient {
     ...
     */
    TenantsClientImpl(ResourceManagementClientImpl client) {
        this.service = RestProxy.create(TenantsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for ResourceManagementClientTenants to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
