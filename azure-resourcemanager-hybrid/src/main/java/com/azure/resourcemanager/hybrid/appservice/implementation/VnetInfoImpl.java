...
public final class VnetInfoImpl implements VnetInfo, VnetInfo.Definition, VnetInfo.Update {
    ...
    VnetInfoImpl(String name, com.azure.resourcemanager.hybrid.appservice.AppServiceManager serviceManager) {
    ...
    VnetInfoImpl(VnetInfoInner innerObject, com.azure.resourcemanager.hybrid.appservice.AppServiceManager serviceManager) {
