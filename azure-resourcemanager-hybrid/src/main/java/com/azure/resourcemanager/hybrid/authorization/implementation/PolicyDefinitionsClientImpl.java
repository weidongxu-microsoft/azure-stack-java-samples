...
import com.azure.resourcemanager.hybrid.authorization.models.PolicyDefinitionListResult;
...
public final class PolicyDefinitionsClientImpl implements PolicyDefinitionsClient {
     ...
     */
    PolicyDefinitionsClientImpl(AuthorizationManagementClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for AuthorizationManagementClientPolicyDefinitions to be used by the
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(String policyDefinitionName, Context context) {
        ...
        return service
            .delete(
                this.client.getEndpoint(), policyDefinitionName, apiVersion, this.client.getSubscriptionId(), context);
    }
                ...
                context ->
                    service
                        .deleteAtManagementGroup(
                            this.client.getEndpoint(), policyDefinitionName, apiVersion, managementGroupId, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<PagedResponse<PolicyDefinitionInner>> listBuiltInSinglePageAsync() {
        ...
        final String accept = "application/json, text/json";
        return FluxUtil
            .withContext(context -> service.listBuiltIn(this.client.getEndpoint(), apiVersion, accept, context))
            .<PagedResponse<PolicyDefinitionInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
    ...
    private Mono<PagedResponse<PolicyDefinitionInner>> listBuiltInSinglePageAsync(Context context) {
        ...
        context = this.client.mergeContext(context);
        return service
            .listBuiltIn(this.client.getEndpoint(), apiVersion, accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
                ...
                context ->
                    service
                        .listByManagementGroup(
                            this.client.getEndpoint(), apiVersion, managementGroupId, accept, context))
            .<PagedResponse<PolicyDefinitionInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
    ...
    private Mono<PagedResponse<PolicyDefinitionInner>> listByManagementGroupSinglePageAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .listByManagementGroup(this.client.getEndpoint(), apiVersion, managementGroupId, accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
