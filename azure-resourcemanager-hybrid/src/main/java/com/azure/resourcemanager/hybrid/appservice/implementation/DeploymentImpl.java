...
public final class DeploymentImpl implements Deployment, Deployment.Definition {
    ...
    DeploymentImpl(
        DeploymentInner innerObject, com.azure.resourcemanager.hybrid.appservice.AppServiceManager serviceManager) {
    ...
    DeploymentImpl(String name, com.azure.resourcemanager.hybrid.appservice.AppServiceManager serviceManager) {
