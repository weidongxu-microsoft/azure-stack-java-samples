...
import com.azure.resourcemanager.hybrid.authorization.models.OperationListResult;
...
public final class AuthorizationOperationsClientImpl implements AuthorizationOperationsClient {
     ...
     */
    AuthorizationOperationsClientImpl(AuthorizationManagementClientImpl client) {
        this.service =
            RestProxy
    ...
    /**
     * The interface defining all the services for AuthorizationManagementClientAuthorizationOperations to be used by
