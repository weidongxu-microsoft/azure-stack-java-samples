...
import com.azure.resourcemanager.hybrid.authorization.models.RoleDefinitionListResult;
...
public final class RoleDefinitionsClientImpl implements RoleDefinitionsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<RoleDefinitionInner>> getByIdWithResponseAsync(String roleDefinitionId) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RoleDefinitionInner> getByIdAsync(String roleDefinitionId) {
