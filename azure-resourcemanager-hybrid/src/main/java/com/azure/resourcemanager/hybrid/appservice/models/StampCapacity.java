...
@Fluent
public final class StampCapacity {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(StampCapacity.class);
     ...
     * @return the StampCapacity object itself.
     */
    public StampCapacity withIsLinux(Boolean isLinux) {
